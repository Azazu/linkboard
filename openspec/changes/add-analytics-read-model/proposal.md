...
- **2026-09-11 — `top-links` keeps its unique visitors** (Gate 2 confirmation 1, finding 4): the original contract is met — the count is exact and measured at 260 ms p95 uncached on one million clicks through the two-level statement of design decision 2.
