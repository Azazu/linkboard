...
- **THEN** the response is the 404 problem details within 3 seconds of the lookup's start, the probe's dependency checks were not run, and a `warning` record names the failure class
