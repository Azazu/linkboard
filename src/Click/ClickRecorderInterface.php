 ...
 * re-implements this with a message and a Redis counter without touching the
 * redirect. Implementations throw on infrastructure failure; the caller
 * decides what a failed record means for the response.
 */
